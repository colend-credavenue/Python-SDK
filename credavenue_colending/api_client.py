...
from credavenue_colending import rest
from credavenue_colending.configuration import Configuration
from credavenue_colending.exceptions import ApiTypeError, ApiValueError, ApiException
from credavenue_colending.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ColendingApi()
        api_instance.agreement_signed  # this is an instance of the class Endpoint
        api_instance.agreement_signed()  # this invokes api_instance.agreement_signed.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.agreement_signed.callable or self.callable in this class
