...
from credavenue_colending.exceptions import ApiValueError
...
conf = credavenue_colending.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://colend-uat-01-api.credavenue.in/colending" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("credavenue_colending")
        ...
        return [
            {
                ...
                'variables': {
                    'host': {
                        'description': "For UAT environment",
                        'default_value': "https://colend-uat-01-api.credavenue.in/colending",
                        }
                    }
            },
            {
                'url': "http://localhost:3000/colending",
                'description': "Local",
            },
            {
                'url': "https://colend-api.credavenue.com/colending",
