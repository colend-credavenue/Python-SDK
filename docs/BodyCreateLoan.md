...
**ckyc_download_identifier** | **str** | CKYC Download Identifier | [optional]
...
**writeoff_amount_suitfiled_settled_in_last_36_months** | **float** | Amount of writeoffs settled in last 36 months | [optional]
**dpd_days_last_1_month** | **int** | Number of DPD in last 1 month | [optional]
**dpd_days_last_3_months** | **int** | Number of DPD in last 3 months | [optional]
...
**loan_eligibility_to_income_ratio** | **int** | The ratio of loan amount eligible to the personal income | [optional] 
**risk_category** | **str** | Risk Category | [optional] 
**salary_credit_declared_income** | **int** | Ratio of salary credit to customer account to the income declared | [optional]
