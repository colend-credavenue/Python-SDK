...
with credavenue_colending.ApiClient(configuration) as api_client:
    ...
    body_create_loan = BodyCreateLoan(
        ...
        ckyc_download_identifier="ckyc_download_identifier_example",
        ...
        writeoff_amount_suitfiled_settled_in_last_36_months=10000,
        dpd_days_last_1_month=4,
        dpd_days_last_3_months=20
        ...
        loan_eligibility_to_income_ratio=2,
        risk_category="red",
        salary_credit_declared_income=3,
...
with credavenue_colending.ApiClient(configuration) as api_client:
    ...
    body_create_tranche = BodyCreateTranche(
        ...
        bureau_report_data=ResponseCreateTrancheBureauReportData(
            ...
            value_of_total_unsecured_loans=3.14,
            writeoff_amount_suitfiled_settled_in_last_36_months=10000.0,
            dpd_days_last_1_month=4,
            dpd_days_last_3_months=12,
            number_of_loans=1,
            value_of_total_loans=3.14,
            number_of_enquiries_3months=1,
            number_of_enquiries_6months=1,
